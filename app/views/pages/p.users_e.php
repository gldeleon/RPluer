...
<div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div id="su" class="alert alert-success"><center><h2>Usuario Eliminado Correctamente</h2></center></div>
...
<div id="alta" title="Basic dialog">
  <form action="index.php" method="post">
    <div class="col-md-12">
      ...
      <br />
      <input type="submit" class="alert-warning form-control" name="altanuserf" value="Guardar" />
    </div>
