...
?>
<div class="row">
	<center><h2>Modificar Relojero</h2></center>
</div>
<br />
<div class="row">
	<div class="col-lg-12">
		<div class="col-lg-6">
			...
			<input type="text" name="email" class="form-control" placeholder="Email: <?php echo $data->ESTADO; ?>" /><br />
			...
			<button type="submit" name="actualizarelojero" class="btn btn-warning" >Guardar Cambios</button>
		</form>
		</div>		
	</div>
</div>
