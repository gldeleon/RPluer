                ...
                <div class="row">
                	...
                	<form action="index.php" method="post">
                		<div class="col-md-6">
					        ...
					        <br />
					        <input class="form-control" type="text" name="marca_desc" placeholder="Descripción" required="required" />
                			<br />
                			<textarea placeholder="TRABAJOS A REALIZAR / PRESUPUESTO" class="form-control" name="trabajos" required="required" ></textarea>
                			<br />
                			<input class="form-control" type="text" name="ref" placeholder="REFERENCIA" /><br />
                			<!--<label for="matcaja">Mat. Caja</label>-->                			
                		</div>
                		<div class="col-md-6">
                			<!--<label for="fecha">Fecha: </label>-->
                			<input class="form-control" type="text" name="serie" placeholder="NO. SERIE" />
                			<br />
                			...
                			<select name="matcaja" class="form-control" required="required">
					        	<option value="">--Selecciona Cristal/Piedra--</option>
                			...
                			<br />
                			<textarea placeholder="CONDICIONES EN QUE SE RECIBE" class="form-control" name="condiciones" required="required" ></textarea>
                			<br />
                		</div>
                		</div>
                		<div class="col-md-8">
...
<div id="dialog" title="Basic dialog">
	<form action="index.php" method="post">
		<div class="col-md-12">
			<input type="hidden" name="formaltctejy" />
