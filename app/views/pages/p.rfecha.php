...
<div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <label>Selecciona Rango de Fecha</label>
                    <br />
                    ...
                    <div class="col-md-4">
                              <input class="form-control" id="datepicker1" type="text" name="fecha1" placeholder="FECHA" required="required" />
                    </div>
                        <div class="col-md-4">
                            <button type="submit" name="rfecha" class="btn btn-warning">Buscar! </button>
                        </div>                        
                        </form>
		</div>
               	<br />
                ...
                <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-fechas">
                                    <thead>
                                        <tr>
                                            <th>Tarjeta</th>
                                            <th>Cliente</th>
