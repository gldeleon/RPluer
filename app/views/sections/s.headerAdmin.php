...
<div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="index.php?action=usr"><i class="fa fa-fw fa-users"></i> Usuarios</a>
                        </li>                  
                        <li>
                            <a href="index.php?action=ctes"><i class="fa fa-fw fa-users"></i> Clientes</a>
                        </li>
                        <li>
                            <a href="index.php?action=relojeros"><i class="fa fa-fw fa-users"></i> Relojeros</a>
                        </li>
                        <li>
