...
<div class="row">
	<!--<?php if (isset($_GET['e']))
		if($_GET['e'] == urlencode("Error en acceso")){
			?>
			<div class="alert alert-warning"><center><h2>Error en el inicio de sesión. Favor de revisar los datos.</h2></center></div>
			<?php
		}
	?>-->
	<br />
                    ...
                    <div class="panel-body">
                        <form role="form" method="post" action="index.php">
                            <fieldset>
                                ...
                                <div class="form-group">
                                	<input class="form-control" placeholder="" name="sesion" type="hidden">
                                </div>
