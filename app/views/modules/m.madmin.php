<div id="page-wrapper">
                	...
                	<!--<form action="index.php" method="post">-->
                		...
                		<div class="col-md-6">
                			...
                			<div class="input-group">
						        <input type="text" class="form-control" id="cvecte" name="cvecte" placeholder="CLIENTE" required="required"> 
					        ...
					        <br />
					        <input class="form-control" type="text" name="marca_desc" placeholder="Descripción del reloj" required="required" />
					        <br />
                			<input id="nocaja" class="form-control" type="text" name="nocaja" placeholder="No. CAJA" required="required" />
                			<div id="resultado"></div>
                			<!--<label for="calibre">Calibre: </label>-->
                			<!--Lo pone el Relojero-->
                			<!--<br />
                			<input class="form-control" type="text" name="calibre" placeholder="CALIBRE" required="required" />-->
                			<br />
                			<input class="form-control" type="text" name="garantia" placeholder="GARANTIA" />
                			<br />
                                        <input type="text" name="foliojoyeria" class="form-control" placeholder="FOLIO JOYERIA" />
                                        <br />
                		...
                		<div class="col-md-6">
                			...
                			<br />
                			<input class="form-control" type="text" name="cajaadc" placeholder="DETALLES DE CAJA" required="required" />                			
                			<br />
                			<input class="form-control" type="text" name="modelo" placeholder="MODELO" required="required" />
                			<!--Lo pone el relojero-->
                			<br />
                			<input class="form-control" type="text" name="referencia" placeholder="REFERENCIA" required="required" />
            ...
            <span class="help-block">
                		...
                		<!--<div class="col-md-3">
                                    <!--<a id="agregarCampo" class="btn btn-info" href="#">Agregar Foto</a><br /><br />-->
                                                    ...
                                                    <span class="input-group-btn">
                                                        <label class="btn btn-primary btn-file" for="multiple_input_group">
                                                            <div class="input required">
                                                                <input id="multiple_input_group" type="file" name="archivo[]" multiple>
                                                            </div> 
                                       ...
                                       <div class="input-group">
                                                ...
                                                <!--<div class="col-md-8">
                                                    <input type="file" id="foto" name="archivo[]"></input><a href="#" class="eliminar"><i class="fa fa-times-circle"></i></a>
                                                    <input type="file" id="foto" name="archivo[]"></input><a href="#" class="eliminar"><i class="fa fa-times-circle"></i></a>
                                                    <input type="file" id="foto" name="archivo[]"></input><a href="#" class="eliminar"><i class="fa fa-times-circle"></i></a>
                                                    <input type="file" id="foto" name="archivo[]"></input><a href="#" class="eliminar"><i class="fa fa-times-circle"></i></a>
                                                    <input type="file" id="foto" name="archivo[]"></input><a href="#" class="eliminar"><i class="fa fa-times-circle"></i></a>
                		...
                		<div class="col-lg-12">
                                    <br />
                                        <input type="hidden" name="tipo" value="reloj" />
                			<input type="submit" name="formulariofolio"  class="btn alert-warning form-control" value="Crear ODT" />
                		</div>                		
                	</form>
                </div>
			</div>
  ...
  $(function(){
    ...
    $(AddButton).click(function (e) {
        if(x <= MaxInputs) //max input box allowed
        {
            FieldCount++;
            //agregar campo
            $(contenedor).append('<input type="file" id="foto" name="archivo[]"></input><a href="#" class="eliminar"><i class="fa fa-times-circle"></i></a>');
